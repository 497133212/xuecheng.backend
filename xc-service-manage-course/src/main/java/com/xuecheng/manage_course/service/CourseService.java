...
public class  CourseService {
    ...
    public CourseMarket updateCourseMarket(String id, CourseMarket courseMarket) {
        ...
        if (one != null) {
            ...
            if(one.getPrice() != null && !courseMarket.getPrice().equals(one.getPrice())) {
    ...
    public CoursePublishResult publish(String id) {
        ...
        //保存课程的发布状态为“已发布”
        String status = "202002";
        CourseBase courseBase = this.saveCoursePubState(id, status);
        if (courseBase == null) {
            return new CoursePublishResult(CommonCode.FAIL, null);
        }
    ...
    private CourseBase saveCoursePubState(String courseId, String status) {
        ...
        courseBaseById.setStatus(status);
    ...
    public UploadFileResult upload(MultipartFile multipartFile,
        ...
        System.out.println("---------------------------------------------------------------");
        return new UploadFileResult(CommonCode.SUCCESS, null);
    }
