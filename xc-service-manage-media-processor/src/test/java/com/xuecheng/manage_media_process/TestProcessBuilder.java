...
//        processBuilder.command("java","-jar","f:/xc-service-manage-course.jar");
    ...
    public void testProcessMp4(){
        ...
        //ffmpeg的路径
        String ffmpeg_path = "F:\\software\\ffmpeg\\ffmpeg-20180227-fa0c9d6-win64-static\\bin\\ffmpeg.exe";
        //video_path视频地址
        String video_path = "F:\\DMDQ\\teach\\xcEdu\\develop\\video\\lucene.avi";
        //mp4_name mp4文件名称
        String mp4_name  ="1.mp4";
        //mp4folder_path mp4文件目录路径
        String mp4folder_path="F:/DMDQ/xuecheng/develop/video/test/";
